...
import ru.projectatkin.education.ModelAndData.data.lowercase.Profile
import ru.projectatkin.education.ModelAndData.data.lowercase.ProfileViewModel
...
class FragmentProfile() : Fragment() {
    ...
    private fun addDataToDatabase() {
        ...
        if (inputCheck(name, password, email, telephone)) {
            val profile = Profile(name, password, email, telephone, profileId)
    ...
    private fun inputCheck(
        ...
        return !(TextUtils.isEmpty(name) && TextUtils.isEmpty(password) && TextUtils.isEmpty(email) && TextUtils.isEmpty(
            telephone
        ))
    }
}